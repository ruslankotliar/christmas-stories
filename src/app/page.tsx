      ...
      <div className="z-10">
        <section id="banner" className="h-screen pt-20 md:pt-32 relative">
          <div className="max-w-screen-xl mx-auto h-full px-8">
            <div
              className="absolute left-0 bottom-24 md:bottom-28 right-0 mx-auto z-30"
            ...
            <div className="w-full h-full">
              <div className={`flex flex-col justify-center items-center`}>
                <h1 className="text-xl md:text-2xl flex justify-between items-start md:gap-2 md:block relative">
                  <div className="flex flex-col justify-between">
                    <span className="text-center text-darkGreen">РІЗДВЯНІ ІСТОРІЇ</span>
                    <span className="text-center text-darkGreen">Кловського саду</span>
                  </div>
                  <span className="hidden md:block absolute md:h-10 md:w-10 text-green md:bottom-1/4 md:-right-12">
                    <SnowflakeIcon />
                  </span>
                </h1>
                <div>
              ...
              <div>
                <p className={`text-sm md:text-base`}>
                  Різдво — надзвичайно світле, тепле свято з глибоким корінням та найулюбленіше
                  свято дорослих та дітей! Цього року Кловський Сад створює неповторну благодійну
                  фотозону «Різдвяні історії», щоб кожен міг закарбувати найгарніші моменти та
                  долучитися до чудової доброї справи. Весь грудень містяни та гості столиці зможуть
                  зробити атмосферні фото на казковому фасаді.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="services"
          className="h-screen flex justify-center items-center pt-20 md:pt-32 pb-10 md:pb-16 z-50"
        >
          <div className="w-screen max-w-screen-xl mx-auto px-8 h-full flex flex-col justify-between gap-10 md:gap-14">
            ...
            <div className="flex flex-col justify-between">
              <div className="w-full flex justify-center items-center mb-5">
                <Link
                  href={'https://send.monobank.ua/jar/9jkK9buWZ6'}
                  // href={'#calendar'}
              ...
              <div>
                <span className="italic text-sm md:text-base">
                  * Бронювання доступне <strong>виключно</strong> після оплати
                </span>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="p-4 rounded-md shadow-md bg-green">
                  <p className="text-sm md:text-base">
                    ...
                    — громадська організація, яка профільно займається ментальною реабілітацією
                    дітей, які зіштовхнулись із жахіттями війни. Команда Gen проводить психологічні
                    інтенсиви, створює новітні програми реабілітації, веде наукову діяльність, а
                    також реалізує проєкти, шо покликані покращити ментальне здоров’я дітей та
                    дорослих. Gen лікує невидимі рани дітей заради нашого спільного щасливого
                    майбутнього.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-screen-xl px-8 w-full flex flex-col md:flex-row justify-start md:justify-between items-center h-full gap-5 md:gap-10">
            <div className="md:w-1/2 mb-4 md:mb-0">
              ...
              <p className="mt-2 md:mt-4 text-sm md:text-base">
                <span className="font-bold">* запрошені фотографи</span> присутні на локації у
                вихідні дні (субота та неділя) з 10.00 до 15.00 та приймають гостей до зйомки за
                попереднім записом 🫶
              </p>
            </div>
            ...
            <div className="md:w-1/2">
              <div className="p-4 md:p-8 shadow-md rounded-md bg-green">
                <p className="text-base md:text-lg font-bold">
                  ...
                  перенесені. Розраховуємо на ваше розуміння та будемо оперативно сповіщати про
                  зміни у нашому інстаграмі ❄️
                </p>
...
const FrameComponent = () => {
  return (
    <>
      <div className="w-screen h-80 top-10 md:top-16 fixed -translate-y-1/2 z-20">
        <Image
      ...
      {['-left-10 md:left-0 -translate-x-1/2', '-right-10 md:right-0 translate-x-1/2'].map(
        (pos, index) => (
          <div key={index} className={`${pos} h-screen w-60 fixed z-20`}>
            <Image
      ...
      <div className="w-screen h-80 -bottom-10 fixed translate-y-1/2 z-20">
        <Image
